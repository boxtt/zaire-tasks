...
function UpCookie2($c){
		$file="cookie_1396.php";
		$cache	= "<?php\r\n";
		$cache .= "\$cookie['value']    =	'$c';\r\n";
		$cache .= "\$cookie['time']		=	".time().";\r\n";
		$zt=agWriteCookie($file,$cache);
		return $zt;
}
function UpCookie($c){
		$file="cookie_168.php";
...
function agWriteCookie($filename,$data,$method="rb+",$iflock=1){
	@touch($filename);
