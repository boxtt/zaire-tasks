!function (t) {
  ...
  function h(t, e) {
    for (var i in e)
      t = d(t, encodeURIComponent(i), encodeURIComponent(e[i]));
    return t
  }
  ...
  function g(t) {
    var e, i, n = 0, s = 0, r = t.getPTPpos(), o = t.getPTPsize(), a = u(), c = f(), d = 0;
    return d = r[1] - c,
    d >= t.sizeSC.height / 2 && a - d - o[1] / 2 >= t.sizeSC.height / 2 ? (n = r[1] + o[1] / 2 - t.sizeSC.height / 2,
    s = r[0] + 45,
    e = "top: 50%;",
    i = "top: 50%;") : d <= t.sizeSC.height / 2 ? (n = r[1] - d,
    s = r[0] + 45,
    e = "top: " + (d + o[1] / 2) / t.sizeSC.height * 100 + "%;",
    i = e) : a - d >= o[1] && a - d - o[1] / 2 <= t.sizeSC.height / 2 ? (n = a - t.sizeSC.height + c,
    s = r[0] + 45,
    e = "top: " + (t.sizeSC.height - (a - d - o[1] / 2)) / t.sizeSC.height * 100 + "%;",
    i = e) : a - d <= o[1] ? (n = r[1] + o[1] - t.sizeSC.height,
    s = r[0] + 45,
    e = "top: " + (t.sizeSC.height - o[1] / 2) / t.sizeSC.height * 100 + "%;",
    i = e) : (n = r[1] + o[1] / 2 - t.sizeSC.height / 2,
    s = r[0] + 45,
    e = "top: 50%;",
    i = "top: 50%;"),
    [n, s, e, i]
  ...
  function v(t, e) {
    return !(1 != t && 2 != t || 10 != e && 11 != e && 12 != e && 13 != e && 14 != e)
  }

  function w(t, e) {
    return !(1 != t && 2 != t || 10 != e && 11 != e && 13 != e && 14 != e)
  }
  ...
  !function () {
    ...
    var s = function () {
      var t;
      return t = navigator.languages && navigator.languages[0] ? navigator.languages[0] : navigator.language || navigator.userLanguage,
      t ? t.toLowerCase().replace(/_/, "-") : null
    }()
    , r = {
      rightToLeft: !1
    };
    ...
    r.init = function (o) {
      ...
      /-/.test(a) && (c = a.split("-")[0]),
      e[a] || (a = e[c] ? c : n);
      for (var d = e[a], h = 0; h < t.length; h++)
        r[t[h]] = void 0 === d[h] ? e[n][h] : d[h];
      "ar" !== a && "he" !== a && "iw" !== a || (r.rightToLeft = !0),
      r.currentLanguage = a
    }
    ,
    r.init(),
    window.captchaSimple = r
  }();
  var _, C = window.captchaSimple, x = function () {
    var t = 1
    , e = function (e) {
      return e = /subsid=\d+/.test(e) ? e.replace(/subsid=\d+/g, "subsid=" + t) : e.indexOf("?") >= 0 ? e + "&subsid=" + t : e + "?subsid=" + t,
      t++,
      e
    };
  ...
  }, z = !!window.ActiveXObject, E = z && 7 == document.documentMode, I = z && 8 == document.documentMode,
  T = z && 9 == document.documentMode, k = {
    ...
    !0)
  }, O = F("Object"), R = F("Function"), N = function (t, e) {
    if (t && e) {
      if (O(e)) {
        for (var i in e)
          t.style[i] = e[i];
    ...
    i.src = x(o),
    i.onload = function () {
      i && e.parentNode && e.parentNode.removeChild(i),
      r = null
    }
    ,
    i.onerror = t.error || function () {
    }
    ,
  ...
  l.prototype = {
    init: function (t) {
      return this.opts = W(q, t || {}),
      this.initOptions(),
      this.listenFunc = [],
      this.readyFunc = [],
      this.msg = new TCapMsg("parent"),
      this.initListener(),
      this.create(),
      this.sess = "",
      this
    ...
    create: function () {
      ...
      switch (this.opts.type) {
        ...
        case "embed":
          ...
          , r = function (e) {
            if (e.ticket)
              for (var n = 0, s = t.listenFunc.length; n < s; n++)
                t.listenFunc[n]({
                  ret: G.ERR_CODE_SUC,
                  ticket: e.ticket,
                  randstr: e.randstr
              ...
              t.prehandleLoadTime = a - i,
              t.createIframeStart = a,
              t.createSecurityCode(x(o), r, captype, subcaptype, t.opts.ele)
            }
          }
          , o = function () {
            V({
              ...
              error: function () {
                ...
                n < 2)
                  ...
                  for (var e = 0, i = t.listenFunc.length; e < i; e++)
                    t.listenFunc[e]({
                      ret: G.ERR_CODE_SUC,
        ...
        case "popup":
          if (t.opts.tcaptchaFlag) {
            ...
            t.createSmartVerify(document.body)
          }
          if (window.document.getElementById("tcaptcha_load")) {
            var e = window.document.getElementById("tcaptcha_load");
            e.style.display = "none"
          ...
          , r = function (e) {
            ...
            if (t.prehandleLoadTime = n - i,
            t.createIframeStart = n,
            e.ticket)
              if (t.opts.tcaptchaFlag)
                setTimeout(function () {
                  t.changeVerifyType();
                  for (var i = 0, n = t.listenFunc.length; i < n; i++)
                    t.listenFunc[i]({
                      ret: G.ERR_CODE_SUC,
                      ticket: e.ticket,
                      randstr: e.randstr
                ...
                for (var s = 0, r = t.listenFunc.length; s < r; s++)
                  t.listenFunc[s]({
                    ret: G.ERR_CODE_SUC,
                    ticket: e.ticket,
                    randstr: e.randstr
              ...
              a = x(a),
              1 == v(captype, subcaptype) ? w(captype, subcaptype) && t.opts.tcaptchaFlag ? setTimeout(function () {
                t.enlargeVerifyType(window.document.getElementById("t_verify"), o.width, o.height),
                t.createSecurityCode(a, {
                  width: o.width,
                  height: o.height
    ...
    createPreTrigerPoint: function () {
      ...
      i.marginheight = 0,
      i.marginwidth = 0,
      i.setAttribute("marginheight", "0", 0),
      i.setAttribute("marginwidth", "0", 0),
      i.scrolling = "no";
      var n = P(this.ele, "width")
      , s = P(this.ele, "height")
      , r = 0;
      n && "auto" != n ? parseInt(n, 10) < j.minWidth ? (this.clientW = j.minWidth + "px",
      r = j.minWidth - 2 + "px") : (this.clientW = n,
      r = parseInt(n, 10) - 2 + "px") : (this.clientW = "100%",
      r = I ? "99%" : "100%"),
      !s || "auto" == s || parseInt(s, 10) < j.minHeight ? this.clientH = j.minHeight + "px" : this.clientH = s;
      var o = {
        width: this.clientW,
        height: this.clientH,
      ...
      if (this.opts.firstvrytype && 2 == this.opts.firstvrytype && (this.clientW = J.width + "px",
      this.clientH = J.height + "px",
      a = {
        width: this.clientW,
        height: this.clientH,
        border: "none",
      ...
      this.src) {
        ...
        var c = 0;
        this.clientH.length > 2 && (c = this.clientH.substr(0, this.clientH.length - 2)),
        this.src = h(this.src, {
          uid: this.opts.uin,
          cap_cd: this.opts.capcd,
          height: c,
    ...
    initListener: function () {
      ...
      this.msg.listen(function (n) {
        ...
        c) {
          ...
          case 3:
            if (B("tcaptcha_container"),
            B("tcaptcha_transform"),
            B("t_mask"),
            s.subsid && x.set(s.subsid),
            t.opts.startFn(),
            s && s.ticket) {
              t.ticket = s.ticket,
              t.randstr = s.randstr;
              for (var d = 0, p = t.listenFunc.length; d < p; d++)
                "embed" == t.opts.type && t.opts.keepOpen ? (t.listenFunc[d]({
                  ret: 0,
                  ticket: s.ticket,
                  randstr: s.randstr
                }),
              ...
              if ("point" == t.opts.type)
                if (s.noVerify)
                  setTimeout(function () {
                    ...
                    N(window.document.getElementById("loading_animation"), e),
                  ...
                  N(window.document.getElementById("loading_animation"), l),
                  t.send2preTriggerPoint(JSON.stringify({
                    message: {
                      type: "success"
                    }
          ...
          case 6:
            if ("embed" == t.opts.type && B("cap_iframe"))
              return;
            if (B("tcaptcha_container"),
            B("t_mask"),
            t.listenFunc.length)
              for (var d = 0, p = t.listenFunc.length; d < p; d++)
                t.closeSecurityCode(function () {
                  t.listenFunc[d]({
          ...
          case 7:
            ...
            return N(t.securityIframe, l),
            void t.setPosition(t.securityIframe);
          case 8:
            return t.sess = s.sess,
            x.set(s.subsid),
            void V({
              url: h(t.opts.s_type, {
                uid: t.opts.uin,
              ...
              success: function (e) {
                switch (t.opts.type) {
                  case "embed":
                    ...
                    1 != captype && 2 != captype || 10 != subcaptype && 13 != subcaptype && 14 != subcaptype || (n = {
                      width: 300,
                      height: 230,
                      btn_width: 298
                    }),
                  ...
                  case "popup":
                    ...
                    1 == v(captype, subcaptype) ? t.replaceSccurityCode(x(s), n) : (window.document.getElementById("tcaptcha_transform") && i(window.document.getElementById("tcaptcha_transform"), n.width, n.height + 40),
                    t.replaceSccurityCode(x(s), {
                      width: n.width,
                      height: n.height + 40
                    }));
                    break;
          ...
          case 9:
            ...
            void ("point" == t.opts.type && t.send2preTriggerPoint(JSON.stringify({
              message: {
                type: "triggerSuccess"
              }
            })));
          case 10:
            if (B("t_verify"),
            t.readyFunc)
              for (var d = 0, p = t.readyFunc.length; d < p; d++)
                t.readyFunc[d] && t.readyFunc[d]();
            return;
          case 11:
          ...
          case 12:
            return void (t._div && o(t._div, "shake"));
          case 13:
            if ("embed" == t.opts.type && B("cap_iframe") || B("tcaptcha_container"),
            B("tcaptcha_transform"),
            B("t_mask"),
            t.listenFunc.length)
              for (var d = 0, p = t.listenFunc.length; d < p; d++)
          ...
          case 14:
            ...
            setTimeout(function () {
              r(document.getElementById("tcaptcha_container"), "show"),
              N(t.securityIframe, {
                zoom: 1
              })
            }, 16)),
          ...
          case 15:
            ...
            "point" == t.opts.type)
              ...
              if (window.document.getElementById("tcaptcha_transform"))
                for (var f = e(window.document.getElementById("tcaptcha_transform"), "ticons"), g = f.length, d = 0; d < g; d++)
                  f[d] && (f[d].style.visibility = "visible");
              ...
              S(6) || E || I ? m.attachEvent("onclick", function () {
              ...
              setTimeout(function () {
                ...
                window.document.getElementById("tcaptcha_transform"))
                  for (var t = e(window.document.getElementById("tcaptcha_transform"), "ticons"), i = t.length, n = 0; n < i; n++)
                    t[n] && (t[n].style.visibility = "hidden");
          ...
          case 16:
            ...
            "point" == t.opts.type)
              ...
              "popup" == t.opts.type && w(captype, subcaptype) ? t.getSrc() : t.refresh();
            return
        }
      })
    },
    ...
    replaceSccurityCode: function (t, e) {
      ...
      N(this.securityIframe, n),
      this.setPosition(i.securityIframe)
    },
    ...
    enlargeVerifyType: function (t, e, n) {
      ...
      N(t, o),
      i(t, D.new_slidePuzzle.width, D.new_slidePuzzle.height)
    },
    changeVerifyType: function () {
      var t = this;
      if (window.document.getElementById("dot0_item"))
        for (var e = window.document.getElementsByClassName("dots_item"), i = window.document.getElementsByClassName("dots_item").length, n = 0; n < i; n++)
    ...
    createSecurityCode: function (t, e, i, n, s, r) {
      ...
      this.hasSecurityCode()) {
        ...
        return N(this.securityIframe, u),
        void this.setPosition(l.securityIframe)
      }
      var f = this.opts.htdoc_path;
      if (a(f + "/tcaptcha_animation.css?v=1.0.0"),
      "point" == this.opts.type) {
        var g = p("div");
        g.className = "tcaptcha-container",
        g.id = "tcaptcha_container",
        this._div = g;
        var u = {
          width: this.sizeSC.width + "px",
          height: this.sizeSC.height + "px",
        ...
        this.securityIframe = m,
        g.appendChild(m),
        s.appendChild(g),
        m.src = t,
        this.setDivPosition(g),
        this.initSecurityCodeTarget()
      } else if ("popup" == this.opts.type && w(i, n)) {
        var g = p("div");
        g.className = "tcaptcha-transform",
        g.id = "tcaptcha_transform",
        this._div = g;
        var u = {
          width: this.sizeSC.width + "px",
          height: this.sizeSC.height + "px",
        ...
        N(g, u);
        var y = p("div");
        if (y.className = "ticons",
        S(6))
          var v = this.opts.htdoc_path + "/transform-rfie.png";
        else
          var v = this.opts.htdoc_path + "/transform-refresh.png";
        var _ = {
          position: "absolute",
          height: "70px",
          width: "100%",
        ...
        g.appendChild(x);
        var E = p("p");
        E.className = "transform-header ticons",
        E.id = "transform_header",
        this._ph = E,
        E.innerText = C.c22;
        var I = {
          position: "absolute",
        ...
        N(E, I);
        var T = p("p");
        T.className = "transform-text ticons",
        T.id = "transform_text",
        this._pt = T,
        T.innerText = C.c23;
        var k = {
        ...
        var m = document.createElement("iframe");
        if (m.setAttribute("frameborder", "0", 0),
        m.setAttribute("border", "0"),
        m.marginheight = 0,
        m.marginwidth = 0,
        m.setAttribute("marginheight", "0", 0),
        m.setAttribute("marginwidth", "0", 0),
        m.scrolling = "no",
        "embed" != this.opts.type || 1 != i && 2 != i || 10 != n && 13 != n && 14 != n)
          if ("popup" == this.opts.type && b(i, n))
            var u = {
              display: "block",
              width: this.sizeSC.width + "px",
              height: this.sizeSC.height + "px",
    ...
    refresh: function (t) {
      ...
      this.clearContainer(),
      this.initOptions(),
      t && O(t) && (t.uin && (this.opts.uin = t.uin),
      t.capcd && (this.opts.capcd = t.capcd)),
      this.create())
    },
    ...
    listen: function (t, e) {
      ...
      this.readyFunc.push(e)
    },
    clear: function () {
      this.listenFunc.length = 0,
      this.readyFunc.length = 0
    },
    ...
    setDivPosition: function (t) {
      if ("embed" != this.opts.type) {
        ...
        if ("point" == this.opts.type) {
          ...
          d.appendChild(c),
          setTimeout(function () {
            s(document.styleSheets[document.styleSheets.length - 1], ".tcaptcha-container:before", M.join(""), 0),
            s(document.styleSheets[document.styleSheets.length - 1], ".tcaptcha-container:after", A.join(""), 0)
          }, 1)
        }
        return N(t, {
          top: e + "px",
    ...
    listenResize: function () {
      ...
      window.onresize = function () {
        if (t.securityIframe && t.setPosition(t.securityIframe),
        window.document.getElementById("tcaptcha_container") && t.setDivPosition(window.document.getElementById("tcaptcha_container")),
        window.document.getElementById("tcaptcha_transform") && t.setDivPosition(window.document.getElementById("tcaptcha_transform")),
        window.document.getElementById("t_verify")) {
    ...
    nullIframe: function (t) {
      return t ? (m(this.preTrigerPoint),
      void (this.preTrigerPoint = null)) : (m(this.securityIframe),
      void (this.securityIframe = null))
    }
  },
  t.AqSCode = l
}(window);
