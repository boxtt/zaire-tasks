...
pt.qlogin = function () {
    ...
    if (n.length = 0, !pt.plogin.isTim) {
      if ($.suportActive()) try {
        ...
        for (var o = i.GetArray("PTALIST"), p = o.GetSize(), r = 0; r < p; r++) {
          ...
          c = s.GetDWord("dwSSO_Account_dwAccountUin"), u = "", g = s.GetByte("cSSO_Account_cAccountType"), d = l;
          if (1 == g) try {
  ...
  uistyleCM: function (t) {
    ...
    i = document.location.protocol + "//ui.ptlogin2." + pt.ptui.domain + "/cross_proxy.html#" + e, n = $("proxy");
