;(function (global) {
  ...
  Ta.hack = function () {
    return {
      params: '',
      conf: {sid: 61651582, pf: 1, logo: 255, hot: {}}
    };
  };
})(this);
...
(function (h, n) {
  ...
  function q(c, a, b) {
    ...
    e = {"com.cn": 1, "net.cn": 1, "gov.cn": 1, "com.hk": 1, "co.nz": 1, "org.cn": 1, "edu.cn": 1}, f = d.split(".");
  ...
  function y() {
    try {
      ...
      d = a.width + "x" + a.height, e = a.colorDepth + "-bit", f = (c.language || c.userLanguage).toLowerCase(),
      g = c.javaEnabled() ? 1 : 0, h = (new Date).getTimezoneOffset() / 60, a = "";
